...
jest.mock("@openmrs/esm-framework", () => ({
  ...
  useVisit: jest
    .fn()
    .mockReturnValue({ currentVisit: { uuid: "some-visitUuid" } }),
...
describe("CarePrograms", () => {
  ...
  test("should render error state message in API has error", () => {
    jest
      ...
      .mockReturnValueOnce({
        ...testProps,
        isLoading: false,
        error: new Error("Internal error 500"),
      });
    renderCarePrograms();
  ...
  test("should display patient eligible programs and launch enrollment or discontuntion form", () => {
    ...
    const discontinueButton = screen.getByRole("button", {
      name: /Discontinue/,
    });
