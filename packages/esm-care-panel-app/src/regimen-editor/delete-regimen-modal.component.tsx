        ...
        .then((response) => {
          if (response.status === 204) {
            ...
            showToast({
              ...
              kind: "success",
              description: t(
                "regimenDeletedSuccessfully",
                "Regimen successfully"
              ),
  ...
  return (
    <div>
      <ModalHeader
        ...
        title={t("deleteRegimen", "Delete Regimen")}
      />
      <ModalBody>
        <p>
          {t(
            "deleteRegimenModalConfirmationText",
            "Are you sure you want to delete regimen?"
          )}
        </p>
      </ModalBody>
      <ModalFooter>
