...
const RegimenForm: React.FC<RegimenFormProps> = ({
  ...
  const { regimenEncounter, isLoading, error } = useRegimenEncounter(
    category,
    patientUuid
  );
  ...
  useEffect(() => {
    ...
    if (
      ...
      (regimenEvent === Regimen.stopRegimenConcept ||
        regimenEvent === Regimen.changeRegimenConcept)
    ) {
      const regimenReasonObs = {
        concept: Regimen.reasonCodedConcept,
        value: regimenReason,
      };
      addOrUpdateObsObject(
        regimenReasonObs,
          ...
          <section className={styles.section}>
            ...
            >
              ...
              <RadioButton
                ...
                value={Regimen.startOrRestartConcept}
                disabled={
                  !lastRegimenEncounter.endDate &&
                  lastRegimenEncounter.event !== "STOP ALL"
                }
              />
              ...
              <RadioButton
                ...
                disabled={
                  !lastRegimenEncounter.startDate ||
                  lastRegimenEncounter.event === "STOP ALL"
                }
              />
              <RadioButton
                ...
                disabled={
                  lastRegimenEncounter.endDate ||
                  (!lastRegimenEncounter.uuid && !lastRegimenEncounter.endDate)
                }
              />
              <RadioButton
                key={"undo-regimen"}
            ...
            {regimenEvent ? (
              <>
                ...
                regimenEvent !== "undo" ? (
                  <>
                    ...
                    >
                      <RadioButton
                        key={"standardUuid"}
                        labelText={"Use standard regimen"}
                        value={"standardUuid"}
                      />
                      <RadioButton
                        key={"nonStandardUuid"}
                ...
                (regimenEvent === Regimen.changeRegimenConcept &&
                  ...
                  <RegimenReason
                    category={category}
                    setRegimenReason={setRegimenReason}
                  />
                ) : null}
              </>
            ) : null}
